...
function useIsVisible(ref: React.RefObject<HTMLElement | null>, setActiveSection: React.Dispatch<React.SetStateAction<string>>) {
  ...
  }, [ref, threshold, setActiveSection]);
}
      ...
      <div className="fixed top-0 max-h-[4.5rem] w-full flex py-5 px-[5vw] items-center justify-between z-50 backdrop-blur-md">
        <div className="flex items-center gap-6">
          ...
          <div className="flex justify-center items-center gap-4 my-6">
            ...
            <a href={mailtoHref} target="_blank">
              <svg className="text-slate-200 opacity-60 hover:opacity-100 transition-all duration-200" xmlns="http://www.w3.org/2000/svg" width={28} height={28} viewBox="0 0 24 24">
        ...
        >
          <button 
            ...
            className={`w-full h-full py-5 px-8 active:bg-black/20 active:text-[rgb(105,225,213)] transition-all duration-50 ${activeSection === "home" ? "text-[rgb(105,225,213)]" : ""}`}
          >
            Home
          </button>
          <button
            ...
            className={`w-full h-full py-5 px-8 active:bg-black/20 active:text-[rgb(105,225,213)] transition-all duration-50 ${activeSection === "about" ? "text-[rgb(105,225,213)]" : ""}`}
          >
            About
          </button>
          <button
            ...
            className={`w-full h-full py-5 px-8 active:bg-black/20 active:text-[rgb(105,225,213)] transition-all duration-50 ${activeSection === "project" ? "text-[rgb(105,225,213)]" : ""}`}
          >
            Projects
          </button>
          <button
            ...
            className={`w-full h-full py-5 px-8 active:bg-black/20 active:text-[rgb(105,225,213)] transition-all duration-50 ${activeSection === "contact" ? "text-[rgb(105,225,213)]" : ""}`}
          >
            Contact
          </button>
        </div>
